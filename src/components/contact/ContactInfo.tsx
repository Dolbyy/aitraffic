  ...
  return (
    <div>
      ...
      <p className="text-gray-300 mb-8">
        ...
        Fill out this form, and We'll get back to you to discuss how we can work together.
      </p>
      ...
      <div className="space-y-6">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-400">aitraffic.in@gmail.com</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-400">+91 9597424052</p>
          </div>
        </div>
      </div>
    </div>
